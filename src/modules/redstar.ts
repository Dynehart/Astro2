            ...
            .then(CurrentQueue => {
                ...
                try {
                    CurrentQueue.forEach(async playerInQueue => {
                        ...
                        k++
                        if (k === CurrentQueue.length) {
                            content = `${content.slice(0, content.length - 2)}\n\nSpacefleet or Ender usually have the best bonus percentage for your arts. They can be found around the top 10 best corps by influence. Please leave the corp after your run!`
