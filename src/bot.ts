    ...
    if (oldmessage.content !== newmessage.content) {
        try {
            ...
            let auditlogEmbed = new EmbedBuilder()
                ...
                .setAuthor({ iconURL: newmessage.author.displayAvatarURL(), name: newmessage.member.displayName })
...
bot.on("messageDelete", async (oldmessage) => {
    try {
        ...
        let auditlogEmbed = new EmbedBuilder()
            .setColor(Colors.Red)
            .setAuthor({ iconURL: oldmessage.author.displayAvatarURL(), name: oldmessage.member.displayName })
